...
* GET http://localhost:8080/alticci/{{indice}}
* POST http://localhost:8080/alticci/cache/clear
* GET http://localhost:8080/alticci/cache/Info
* GET http://localhost:8080/q/health
* GET http://localhost:8080/q/dev/
